...
RC CreateVectorIndexExecutor::execute(SQLStageEvent *sql_event) {
  ...
  return table->create_vector_index(trx, create_vector_index_stmt->field_metas(), create_vector_index_stmt->index_name().c_str(),
                                    create_vector_index_stmt->getType(), create_vector_index_stmt->getDistance(),
                                    create_vector_index_stmt->getLists(), create_vector_index_stmt->getProbes());
}
