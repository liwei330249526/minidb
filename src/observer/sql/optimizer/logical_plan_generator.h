...
private:
  ...
  RC create_plan(FilterStmt *filter_stmt, std::unique_ptr<LogicalOperator> &logical_operator, std::unique_ptr<LogicalOperator> &table_oper, std::unique_ptr<LogicalOperator>* &last_oper);
